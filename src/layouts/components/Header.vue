    ...
    <t-head-menu :class="menuCls" :theme="menuTheme" expand-type="popup" :value="active">
      <template #logo>
        <span v-if="showLogo" class="header-logo-container" @click="handleNav('/')">
          <logo-full class="t-logo" v-if="locale === 'en_US'"/>
          <logo-full-zh class="t-logo" v-if="locale === 'zh_CN'" />
        </span>
...
import LogoFull from '@/assets/icons/assets-logo-full-ai.svg?component';
import LogoFullZh from '@/assets/icons/assets-logo-full-ai-zh.svg?component';

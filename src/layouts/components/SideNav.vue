<template>
  <div :class="sideNavCls">
    ...
    >
      ...
      <template #operations>
        <span :class="versionCls"> {{ !collapsed ? 'Version' : '' }} {{ pgk.version }} </span>
      </template>
    </t-menu>
...
import AssetLogoFull from '@/assets/icons/assets-logo-full-ai.svg?component'; // 全
import AssetLogoFullZh from '@/assets/icons/assets-logo-full-ai-zh.svg?component'; // 全
import AssetLogo from '@/assets/icons/assets-t-logo-ai.svg?component'; // 简
